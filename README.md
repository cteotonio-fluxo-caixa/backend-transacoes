...
Execute a ferramenta de teste no diretório onde se encontra a solução do projeto

```
dotnet test --collect:"XPlat Code Coverage"
```

Após a execução do teste será apresentado o **Anexo** normalmente localizado na pasta **TestResults** do seu projeto de testes.
A cada execução dos testes, é gerado uma nova pasta **GUID** da última execução, você irá precisar desta informação para o próximo passo.
Ex.: Diretório completo da solução\TestResults\**a7ad81f8-f6b6-4542-a3b5-c69d305e6b36**\coverage.cobertura.xml

Agora vamos gerar o relatório
Ainda na pasta da solução do projeto digite o seguinte comando
...
Clique no arquivo **index.html** e veja as informações de cobertura por vários níveis, Projeto, Classes e Métodos
